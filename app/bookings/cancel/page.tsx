        ...
        {status !== "success" && (
          <div style={{ background: "white", padding: "48px", borderRadius: "4px", marginBottom: "24px" }}>
            ...
            <button
              ...
              style={{ marginTop: "24px", width: "100%", background: "#dc2626", color: "white", padding: "18px", borderRadius: "4px", fontSize: "13px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", border: "none", cursor: "pointer", fontFamily: "ui-sans-serif, system-ui, sans-serif" }}
            >
